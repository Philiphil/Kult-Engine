...
class JWT{
	...
	{
		if(!in_array($alg, array_keys($this::ALGS))) throw new Exception($alg." not available");
	...
	public static function decode(string $data) : ?self
	{
			...
			if(!JWT::verify($raw[0].".".$raw[1],JWT::base64_url_decode($raw[2]),JWT::$key,$decoded[0]->alg ))throw new \Exception("invalid jwt");
			

			if(!$decoded[1]->verifyClaims())throw new \Exception("invalid informations");
